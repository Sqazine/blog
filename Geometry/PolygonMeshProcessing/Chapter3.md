...
![图 3.2.球体坐标.(图片来自于[Hormann et al.07]).](Chapter3/image-1.png)
...
![图 3.3.将参数空间的切向量 $\bar{ {\rm w} }$ 转换为表面 $S$ 的切向量 ${\rm w}$ ,表面 $S$ 由参数化 ${\rm x}$ 描述](Chapter3/image-2.png)
...
![图 3.9. 三角形上重心插值的线性基函数](Chapter3/image-8.png)
